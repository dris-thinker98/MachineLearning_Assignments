...
class LogRegression(object):
    ...
    def __init__(self, n_iter=1000, learn_rate = 0.03):  #learn_rate value taken from Q2 part
        self.lr = learn_rate
        self.n_iters = n_iter
        self.weights = None
        self.bias = None
    ...
    def getPairs(self):
        pairs = [[0,1],[0,2],[0,3],[1,2],[1,3],[2,3]]   #based on the classes in target variable y
        return pairs
